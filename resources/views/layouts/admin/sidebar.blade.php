<div class="sidebar-menu">
    <div class="sidebar-header">
        <div class="logo">
            <a href="/reports"><img src="/img/logo/logo200.png" alt="logo"></a>
        </div>
    </div>
    <div class="main-menu">
            ...
            <nav>
                <ul class="metismenu" id="menu">
                    <li>
                        ...
                        <ul class="collapse">
                            <li><a href="/admin/post/show">Ver Publicaciones</a></li>
                            <li><a href="/admin/post/create">Agregar Publicacion</a></li>
                            <li><a href="#"></a></li>
                        </ul>
                    </li>
                    <li>
